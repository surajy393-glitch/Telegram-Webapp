...
Frontend (`.env`):
```env
REACT_APP_BACKEND_URL=https://social-connect-264.preview.emergentagent.com
WDS_SOCKET_PORT=443
```
...
Access the app at: `https://social-connect-264.preview.emergentagent.com`
...
🌐 **Live URL:** https://social-connect-264.preview.emergentagent.com
