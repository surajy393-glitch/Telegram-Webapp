...
Frontend (`.env`):
```env
REACT_APP_BACKEND_URL=https://telegram-love-hub.preview.emergentagent.com
WDS_SOCKET_PORT=443
```
...
Access the app at: `https://telegram-love-hub.preview.emergentagent.com`
...
🌐 **Live URL:** https://telegram-love-hub.preview.emergentagent.com
