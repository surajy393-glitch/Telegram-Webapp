...
Frontend (`.env`):
```env
REACT_APP_BACKEND_URL=https://telebot-age.preview.emergentagent.com
WDS_SOCKET_PORT=443
```
...
Access the app at: `https://telebot-age.preview.emergentagent.com`
...
🌐 **Live URL:** https://telebot-age.preview.emergentagent.com
