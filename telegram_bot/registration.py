...
async def start_with_consent(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        "You can delete your data anytime: /delete\\_me",
        parse_mode="Markdown",
        reply_markup=kb
    )
...
async def on_callback(update: Update, context: ContextTypes.DEFAULT_TYPE) -> bool:
    ...
    if data == "privacy_accept":
        ...
        # Send registration message (using the bot's send_message since this is a callback)
        ...
        await q.edit_message_text(
            ...
            "*Your Rights:*\n"
            "• View data: /my\\_data\n"
            "• Delete data: /delete\\_me (24hr grace)\n"
            "• Cancel deletion: /cancel\\_deletion\n\n"
            "*Data Retention:*\n"
...
async def handle_registration_text(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not state:
        # No registration state - user should use /start command
        return
    ...
    # If we reach here, unknown state - just return
    return
